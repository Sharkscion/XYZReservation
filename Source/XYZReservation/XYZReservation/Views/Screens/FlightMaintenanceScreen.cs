            ...
            if(Flights != null)
            {
                ...
                foreach (var flight in Flights)
                {
                    Console.WriteLine("| {0, -15} {1, -15} {2, -20} {3, -20} {4, -15} {5, -15} |", 
                        flight.AirlineCode, 
                        flight.Number.ToString(StringFormats.DISPLAY_FORMAT_FLIGHTNUMBER), 
                        flight.ArrivalStationCode, 
                        flight.DepartureStationCode, 
                        flight.ScheduledTimeArrival.ToString(StringFormats.STANDARD_TIME_FORMAT), 
                        flight.ScheduledTimeDeparture.ToString(StringFormats.STANDARD_TIME_FORMAT));
                }
